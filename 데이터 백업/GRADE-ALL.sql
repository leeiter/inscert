...
SET DEFINE OFF;
Insert into TBL_SCORE (S_ID,S_SCORE,S_REM,S_SUBJECT,S_STD) values (0,90,null,'S001','T0001');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007047" ON "TBL_DEPT" ("D_NUM") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007039" ON "TBL_SUBJECT" ("SB_CODE") 
  ;
--------------------------------------------------------
