...
-- 문자열을 날짜 Type으로 변환 시킬 필요가 있다.

/*
2019-01-01부터 201-01-31까지의 날짜 값을 추출하는 연산
...
-- 2019*-02-01 부터 2019-09-30까지 년, 월만 추출해서
-- 문자열로 생성하기
...
-- Alais 부분은 GRUOP BY에서 인식하지 않는다.
-- HAVING도 계산식을 모두 기술해주어햐 한다.
SELECT
    io_dcode,
